...
def on_message(client, userdata, message):
    ...
    if(msg == 'u'):
        client.publish('overcooked_game1', "Pick Up", qos=1)
    elif(msg == 'd'):
        client.publish('overcooked_game1', "Put Down", qos=1)
    elif(msg == 'cd'):
        client.publish('overcooked_game1', "Chop", qos=1)
        # chop = True
    elif(msg == 'sd'):
        client.publish('overcooked_game1', "Stir", qos=1)
        # stir = True
    elif(msg == 't'):
        client.publish('overcooked_game1', "Tomato", qos=1)
    elif(msg == 'b'):
        client.publish('overcooked_game1', "Bun", qos=1)
    elif(msg == 'l'):
        client.publish('overcooked_game1', "Lettuce", qos=1)
    elif(msg == 'm'):
        client.publish('overcooked_game1', "Meat", qos=1)
    elif(msg == 'p'):
        client.publish('overcooked_game1', "Plate", qos=1)
    # else:
...
def complete_speech_recognition(recognizer, audio):
    ...
    client.publish('overcooked_imu1', imu_msg, qos=1)
    client.publish('overcooked_game1', game_msg, qos=1)
