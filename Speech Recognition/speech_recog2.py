...
valid_items = ['tomato', 'cheese', 'plate']
...
while(True):
    print("Current inventory contains: " + inventory)
    r = sr.Recognizer()
    ...
    try:
        ...
        #print("Google Speech Recognition thinks you said " + recog_word)
        if not inventory: #player inventory is empty, empty 'inventory' is false
            if recog_word in valid_items:
